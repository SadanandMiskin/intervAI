...
mongoose_1.default.connect("mongodb+srv://sada:sada@cluster0.qaxfxid.mongodb.net/?retryWrites=true&w=majority").then(() => console.log('Connected to Mongo')).catch((e) => console.log(e));
...
app.post('/api/tts-stream', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { text } = req.body;
    if (!text) {
        return res.status(400).send('Text is required');
    }
    try {
        const response = yield axios_1.default.post('https://api.elevenlabs.io/v1/text-to-speech/<voice-id>/stream', {
            text: text,
            stream: true
        }, {
            headers: {
...
app.post('/api/stt-stream', (req, res) => {
    try {
        ...
        const elevenLabsRequest = axios_1.default.post('https://api.elevenlabs.io/v1/speech-to-text/<model-id>/stream', audioStream, {
            headers: {
                'xi-api-key': process.env.ELEVEN_LABS_API_KEY,
        ...
        elevenLabsRequest.then((response) => {
...
app.get('/api/sessions', authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
